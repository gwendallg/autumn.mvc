...
{
    public static class AutumnQueryExpressionHelper
    {
            ...
            NamingStrategy namingStrategy = null)
        {
            ...
            var values = AutumnQueryGetValueHelper.GetValues(typeof(bool), context.arguments());
            ...
            NamingStrategy namingStrategy=null)
        {
            ...
            var expressionValue =
                GetMemberExpressionValue<T>(parameter, context, namingStrategy);
            var values = AutumnQueryGetValueHelper.GetValues(expressionValue.Property.PropertyType, context.arguments());
            if (values == null || values.Count == 0) throw new AutumnQueryComparisonNotEnoughtArgumentException(context);
            if (values.Count > 1) throw new AutumnQueryComparisonTooManyArgumentException(context);
...
#pragma warning restore 1570
            ...
            NamingStrategy namingStrategy=null)
        {
            ...
            {
                method = AutumnQueryReflectionHelper.MethodStringContains;
            }
            else if (criteria.StartsWith("*"))
            {
                method = AutumnQueryReflectionHelper.MethodStringEndsWith;
            }
            else
            {
                method = AutumnQueryReflectionHelper.MethodStringStartsWith;
            }
            ...
            NamingStrategy namingStrategy = null)
        {
            ...
            var methodContainsInfo = AutumnQueryReflectionHelper.GetOrRegistryContainsMethodInfo(expressionValue.Property.PropertyType);
        ...
        public static AutumnExpressionValue GetMemberExpressionValue<T>(ParameterExpression parameter,
            string selector,
            NamingStrategy namingStrategy = null)
        {
            if (parameter == null) throw new ArgumentException("parameter");
            ...
            if (selector.IndexOf(".", StringComparison.InvariantCulture) != -1)
            {
                ...
                {
                    property = AutumnQueryReflectionHelper.GetOrRegistryProperty(type, item, namingStrategy);
                    if (property == null)
                    {
            ...
            {
                property = AutumnQueryReflectionHelper.GetOrRegistryProperty(type, selector, namingStrategy);
                if (property == null)
                {
                    throw new Exception(string.Format("Invalid property {0}", selector));
                }
            ...
            return new AutumnExpressionValue()
            {
                Property = property,
        ...
        private static AutumnExpressionValue GetMemberExpressionValue<T>(ParameterExpression parameter,
            AutumnQueryParser.ComparisonContext context,
            NamingStrategy namingStrategy = null)
        {
            if (parameter == null) throw new ArgumentException("parameter");
